...
description: >
  Walk the PM through the Operate phase of the agentic PM lifecycle. Acts on what Observe is showing. Governance runs at runtime. Produces: drift detection across six vectors (attentional, substrate, observational, compensatory, security, scope), Sealed Decision Artifact at the real limitations period, instrument half-life policy, constitutional runtime rules, affected-person audit view, adaptive governance rule set, authority delegation audit, the Currency Question, external audit. Trigger phrases: "drift detection", "operating an agent over time", "constitutional runtime", "the model underneath has shifted", "Sealed Decision Artifact", "appeal", "instrument re-calibration", "currency question", "vendor model update", "external audit", "scope drift", "authority delegation". Also trigger when an agent has been live for months or years, or when a compliance review is approaching.
---
